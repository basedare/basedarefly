...
The integrated design-partner operating sequence, cost caps, automated scorecard thresholds, stop conditions, and human activation checklist live in `brain-vault/04-experiments/field-station-backed-verified-sprint.md`. The internal Field Station admin is the live preflight and reporting surface; a `BLOCKED` station must not be printed or activated.
