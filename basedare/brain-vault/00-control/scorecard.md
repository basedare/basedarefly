...
A lead counts as qualified only if it has:

- a clear buyer or operator path
- a reason BaseDare matters to that venue or creator now
- a concrete next action
- enough context to avoid generic outreach

## Weekly Review

Questions to answer at week end:

- Which venues or creators produced a real conversation?
- Which outreach angle created curiosity?
