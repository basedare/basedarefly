...
export default function PeebareBountySpray({ amount = 0 }) {
  return (
    <div className="relative inline-flex items-center gap-2">
      ...
      {/* Bear Mascot Head */}
      <img 
        src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68fdae09d2124933d726e89a/e7800e68e_nano-banana-2025-11-09T02-03-041.png"
        alt="Bear"
