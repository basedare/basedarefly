    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-[#1a1a2e] border border-purple-500/30 rounded-2xl p-6 max-w-md w-full max-w-[100vw]"
          ...
          <div className="space-y-3">
            {WALLETS.map(wallet => (
              <button
                ...
                className="w-full flex items-center gap-4 p-4 bg-gray-800/50 hover:bg-gray-700/50 rounded-xl transition-colors disabled:opacity-50"
              >
