...
export default function MobileNav({ isOpen, onClose, user }) {
  ...
  return (
    <>
      ...
      <div 
        className={`fixed top-0 left-0 h-full w-80 bg-[#0A0A0F] border-r border-white/10 z-50 transform transition-transform duration-300 ${
        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between p-6 border-b border-white/10">
            <div className="flex items-center gap-3">
              <img 
                src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68fdae09d2124933d726e89a/0ddc955b3_image.png"
                alt="BASEDARE Bear"
