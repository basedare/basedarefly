...
const SEEDED_PLACES: SeededPlaceInput[] = [
  ...
  {
    slug: 'bumee-bomi-surf-break',
    name: 'Bumee / Bomi Surf Break',
    description: 'Intermediate outer-reef left beyond Cloud 9. Check tide, wind, reef conditions, and access with a local guide.',
    address: 'Outer reef off Catangnan',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.8216523,
    longitude: 126.1648605,
    timezone: 'Asia/Manila',
    categories: ['surf', 'reef-break', 'outer-reef', 'boat-access', 'intermediate', 'siargao', 'bumee', 'bomi'],
    featuredLabel: 'unmarked',
    seededTags: [],
  },
  {
    slug: 'rock-island-surf-break',
    name: 'Rock Island Surf Break',
    description: 'Boat-access outer-reef right near Stimpy’s. Check conditions and ability fit with a local guide.',
    address: 'Outer reef off Santa Fe',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.838915,
    longitude: 126.160691,
    timezone: 'Asia/Manila',
    categories: ['surf', 'reef-break', 'outer-reef', 'boat-access', 'advanced', 'siargao', 'rock-island'],
    featuredLabel: 'unmarked',
    seededTags: [],
  },
  {
    slug: 'stimpys-surf-break',
    name: 'Stimpy’s Surf Break',
    description: 'Boat-access outer-reef left near Rock Island. Confirm reef, tide, swell, and the safe call locally.',
    address: 'Outer reef off Santa Fe',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.8441334,
    ...
    timezone: 'Asia/Manila',
    categories: ['surf', 'reef-break', 'outer-reef', 'boat-access', 'advanced', 'siargao', 'stimpys'],
    featuredLabel: 'unmarked',
    seededTags: [],
  },
  {
    slug: 'cemetery-surf-break',
    name: 'Cemetery Surf Break',
    description: 'Outer-reef surf zone off General Luna with several peaks. Check currents, tide, and access with a local guide.',
    address: 'Outer reef off General Luna Cemetery',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.784163,
    longitude: 126.1731257,
    timezone: 'Asia/Manila',
    categories: ['surf', 'reef-break', 'outer-reef', 'boat-access', 'intermediate', 'siargao', 'cemetery'],
    featuredLabel: 'unmarked',
    seededTags: [],
  },
  {
