...
export const CURATED_SIARGAO_VENUES: CuratedVenue[] = [
  ...
  },
  {
    ...
    description:
      'Catangnan surf school and board-access stop beside the public beach launch commonly used for Rock Island, Stimpy’s, and Bumee. Confirm rentals, boats, conditions, and the right break with local guides on site.',
    address: 'Barangay Catangnan, General Luna, Surigao del Norte, Philippines',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.8108572,
  ...
  {
    slug: 'greenroom-wine-bar-siargao',
    name: 'Greenroom Wine Bar & Bistro Siargao',
    description:
      'Tuason wine bar directly opposite Harana: a relaxed pre-drink stop before the Saturday crowd crosses the road. Ask staff about the current sangria offer.',
    address: 'Tuason Point, Tourism Road, Catangnan, General Luna, Surigao del Norte, Philippines',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.8073179,
    longitude: 126.1661056,
    timezone: 'Asia/Manila',
    categories: [
      'wine-bar',
      'bar',
  ...
  },
  {
    ...
    timezone: 'Asia/Manila',
    locationConfidence: 'google-maps-cross-checked-openstreetmap-surf-break',
  ...
  },
  {
    ...
    description:
      'Intermediate outer-reef left beyond Cloud 9. Reach it with a local guide or boat and confirm the current tide, wind, and reef conditions first.',
    address: 'Outer reef off Catangnan, General Luna, Surigao del Norte, Philippines',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.8216523,
    longitude: 126.1648605,
    timezone: 'Asia/Manila',
    locationConfidence: 'google-maps-bomi-surf-spot-listing',
  ...
  },
  {
    ...
    description:
      'Boat-access outer-reef right near Stimpy’s. Check conditions and ability fit with a local guide before heading out.',
    address: 'Outer reef off Santa Fe, General Luna, Surigao del Norte, Philippines',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.838915,
  ...
  },
  {
    ...
    description:
      'Boat-access outer-reef left near Rock Island. Reef, tide, and swell can make it demanding, so confirm the safe call locally.',
    address: 'Outer reef off Santa Fe, General Luna, Surigao del Norte, Philippines',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.8441334,
  ...
  },
  {
    ...
    description:
      'Outer-reef surf zone off General Luna with several peaks. Use a local guide or boat and check currents, tide, and ability fit before going.',
    address: 'Outer reef off General Luna Cemetery, Surigao del Norte, Philippines',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.784163,
    longitude: 126.1731257,
    timezone: 'Asia/Manila',
    locationConfidence: 'google-maps-cross-checked-openstreetmap-surf-zone',
    categories: ['surf', 'reef-break', 'outer-reef', 'boat-access', 'intermediate', 'siargao', 'cemetery'],
  },
  {
    slug: 'siargao-wakepark',
    name: 'Siargao Wakepark',
    description:
      'Consuelo cable-park and action-sports lake for wakeboarding, wakeskating, hydrofoil practice, water-zipline sessions, and off-water games.',
    address: 'Barangay Consuelo, General Luna, Surigao del Norte, Philippines',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.8013324,
    longitude: 126.1132557,
    timezone: 'Asia/Manila',
    locationConfidence: 'official-google-maps-destination',
    categories: [
      'activity',
      'wakepark',
      'wakeboard',
  ...
  },
  {
    ...
    description:
      'Sunset longboarding and skating stretch on the Malinao road. Share the road, keep the lane clear, and never film strangers without permission.',
    address: 'Malinao Road, Barangay Malinao, General Luna, Surigao del Norte, Philippines',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.7632,
    longitude: 126.1229,
  ...
  {
    slug: 'secret-beach-malinao',
    name: 'Secret Beach Malinao',
    description:
      'Calm beach and mangrove hangout at the end of Malinao Road. Tide conditions and access rules can change, so follow the signs on arrival.',
    address: 'End of Malinao Road, Barangay Malinao, General Luna, Surigao del Norte, Philippines',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.7571,
    longitude: 126.11595,
    timezone: 'Asia/Manila',
    locationConfidence: 'plus-code-area-entrance-offset',
    categories: [
      'beach',
      'mangrove',
      'swimming',
  ...
  {
    slug: 'kanaloa-siargao',
    name: 'Kanaloa Siargao',
    description:
      'Beach bar beside Secret Beach for sunset, swimming, paddleboarding, and beach volleyball. Confirm current activities and hours with the venue.',
    address: 'Q448+RHJ, Malinao Road, General Luna, Surigao del Norte, Philippines',
    city: 'General Luna',
    country: 'Philippines',
    latitude: 9.7570625,
    longitude: 126.1164375,
    timezone: 'Asia/Manila',
    locationConfidence: 'externally-checked-plus-code-cell-center',
    instagramHandle: '@kanaloasiargao',
    categories: [
      'beach-bar',
      'bar',
      'sunset',
