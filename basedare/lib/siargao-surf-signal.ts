import type { SiargaoTideSignal } from './siargao-tide-signal';
...
export function buildSiargaoSurfSignal(
  payload: unknown,
  receivedAt = new Date(),
  tide: SiargaoTideSignal | null = null,
  ...
  return {
    ...
    caveat: 'Modelled offshore swell plus station-predicted tides—not an observed break report or safety forecast.',
