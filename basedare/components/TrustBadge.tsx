...
export default function TrustBadge() {
  return (
    <section className="w-full py-8 backdrop-blur-xl bg-black/10 border-b border-white/10 flex justify-center gap-8 opacity-60 hover:opacity-100 transition-opacity">
