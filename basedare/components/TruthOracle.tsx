      ...
      <div className="w-full max-w-6xl mx-auto rounded-2xl border border-white/10 bg-black/40 backdrop-blur-2xl shadow-[0_0_50px_rgba(59,130,246,0.1)] overflow-hidden">
        ...
        <div className="p-3 sm:p-4 border-b border-white/10 flex flex-wrap sm:flex-nowrap justify-between items-center gap-2 bg-[#050505]">
          ...
          <div className="flex items-center gap-2 sm:gap-4 text-[9px] sm:text-[10px] font-mono text-gray-500 uppercase">
            <span className="hidden sm:inline">Model: GPT-4o-Vision</span>
          ...
          <div className="lg:col-span-2 lg:border-r border-b lg:border-b-0 border-white/10 bg-black/60 relative group min-h-[250px] sm:min-h-[350px] lg:min-h-[400px]">
            <div className="relative h-full w-full overflow-hidden">
              ...
              <AnimatePresence>
                {analysisStatus === "SCANNING" && (
                  ...
                  >
                    ...
                    {/* Detection Boxes */}
                    <div className="absolute top-[15%] sm:top-[20%] left-[20%] sm:left-[30%] w-20 h-20 sm:w-32 sm:h-32 border border-green-500/30 rounded-lg">
                      <div className="absolute -top-3 sm:-top-4 left-0 text-[8px] sm:text-[10px] bg-green-900/50 text-green-400 px-1 font-mono whitespace-nowrap">FACE_MATCH 98%</div>
                    </div>
                    <div className="absolute bottom-3 sm:bottom-10 right-3 sm:right-10 flex flex-col gap-0.5 sm:gap-1 text-[8px] sm:text-[10px] font-mono text-green-400">
                      <span>{'>'} ANALYZING MOTION...</span>
                      <span className="hidden sm:block">{'>'} AUDIO SPECTRUM MATCH...</span>
              ...
              {analysisStatus === "COMPLETE" && (
                <motion.div
                  ...
                  className="absolute top-2 right-2 sm:top-4 sm:right-4 bg-black/80 backdrop-blur-md border border-green-500/30 p-2 sm:p-4 rounded-xl shadow-[0_0_30px_rgba(34,197,94,0.15)]"
                >
                  <div className="text-[8px] sm:text-[10px] text-gray-400 font-mono uppercase mb-1">AI Confidence</div>
                  <div className="text-xl sm:text-3xl font-black text-green-400 flex items-center gap-1 sm:gap-2">
                    <Scan className="w-4 h-4 sm:w-6 sm:h-6" /> {aiConfidence}%
                  </div>
                  <div className="text-[8px] sm:text-[10px] text-green-600 font-mono mt-1">
                    REC: <span className="font-bold text-green-400">VALID</span>
                  </div>
                </motion.div>
              )}
            </div>
            ...
            <div className="p-3 sm:p-6 border-t border-white/10 bg-[#050505]">
              <h3 className="font-bold text-white text-base sm:text-xl mb-1 flex items-center gap-2 flex-wrap">
                <span>&quot;Eat the Reaper Chip&quot;</span>
                {analysisStatus === "COMPLETE" && <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0" />}
              </h3>
          ...
          <div className="p-4 sm:p-6 flex flex-col bg-[#050505]">
            ...
            <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-purple-900/10 border border-purple-500/20 rounded-xl relative overflow-hidden">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] sm:text-xs font-bold text-purple-300 uppercase">Analysis Report</span>
              </div>
            ...
            <div className="mb-4 sm:mb-6 px-1">
              <div className="flex justify-between items-center mb-2">
                <label className="text-[10px] sm:text-xs text-gray-400 font-mono uppercase font-bold">Pledge Rep</label>
                <span className="text-[10px] sm:text-xs text-blue-400 font-bold">{pledgeAmount} REP</span>
              </div>
              <input
                type="range"
                min="10"
              ...
              />
              <div className="text-[9px] sm:text-[10px] text-gray-500 mt-2 font-mono flex justify-between">
            ...
            <div className="mt-auto space-y-2 sm:space-y-3">
              {voted ? (
                ...
                >
                  ...
                  <p className="text-[9px] sm:text-[10px] text-gray-500 font-mono mt-1">Staked {pledgeAmount} REP on outcome</p>
                </motion.div>
              ) : (
                <>
