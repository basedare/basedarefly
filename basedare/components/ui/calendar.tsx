    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 text-white opacity-50 hover:opacity-100 hover:bg-white/10 border-white/20"
        ),
        ...
        day_today: "bg-purple-900/50 text-white border border-purple-500",
        day_outside:
