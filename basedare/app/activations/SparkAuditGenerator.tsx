...
function buildAuditPlan(input: {
  ...
  return {
    ...
    offer: 'Start with one $2,500 Verified Field Sprint: a $2,000 managed-service fee, a $500 creator pool, four independent field answers, and one honest receipt that decides whether to repeat.',
    summary: [
      ...
      `Audience: ${audience}`,
      `Vibe/story: ${vibe}`,
      `Offer: $2,500 Verified Field Sprint with four independently routed contributors over 7-10 days.`,
