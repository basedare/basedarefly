  ...
  return (
    <div className="relative min-h-screen flex flex-col py-24 px-4 md:px-8">
      <div className="container mx-auto px-6 relative z-10 max-w-4xl flex-grow">
        ...
        {/* FORM */}
        <div className="bg-black/60 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-[0_0_50px_rgba(168,85,247,0.15)] relative overflow-hidden">
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-4">
              ...
              <input 
                ...
                className="w-full h-16 bg-[#0a0a0a] border border-white/10 text-xl font-bold text-white placeholder:text-gray-600 rounded-xl pl-6 focus:border-purple-500 focus:outline-none transition-colors"
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              <textarea 
                ...
                className="w-full min-h-[150px] bg-[#0a0a0a] border border-white/10 text-lg text-white placeholder:text-gray-600 rounded-xl p-6 focus:border-purple-500 focus:outline-none transition-colors resize-none font-mono"
              />
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full h-16 bg-[#0a0a0a] border border-white/10 text-2xl font-black text-[#FFD700] placeholder:text-gray-700 rounded-xl pl-6 focus:border-[#FFD700] focus:outline-none"
                  />
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <input 
                    placeholder="24" 
                    className="w-full h-16 bg-[#0a0a0a] border border-white/10 text-xl font-bold text-white text-center rounded-xl focus:border-blue-500 focus:outline-none" 
                  />
                  <select className="h-16 bg-[#0a0a0a] border border-white/10 text-white rounded-xl px-4 focus:border-blue-500 focus:outline-none font-bold uppercase cursor-pointer">
                    <option>Hours</option>
                    <option>Days</option>
                    <option>Weeks</option>
                  </select>
